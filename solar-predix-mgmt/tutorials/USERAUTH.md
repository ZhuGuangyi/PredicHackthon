...
This tutorial also requires knowledge of and practical experience with the Techmahindra Solar App (this project).  You should have been able to install, minimally configure, and deploy the Seed prior to performing this tutorial.  Please refer to the README document of this project for this requirement.
...
The previous steps showed how authentication is enabled in a local instance of the Techmahindra Solar App application.  Ultimately, we want the authentication feature to be part of deployments to the Cloud.  To achieve this, perform these steps:
